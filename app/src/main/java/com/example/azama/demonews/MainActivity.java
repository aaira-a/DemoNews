...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "http://mnurdin.com/wp-json/wp/v2/posts?filter[posts_per_page]=10&fields=id,title";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postList = (ListView) findViewById(R.id.listNews);
        ...
        rQueue.add(request);
        postList.setOnItemClickListener(new
